 ...
 * Objekt am Ende der Liste gelöscht wurde, gibt es kein aktuelles Objekt.
 ...
 * kann gelesen, verändert oder gelöscht werden. Außerdem kann vor dem 
 * aktuellen Objekt ein Listenobjekt eingefügt werden.
 * 
 * @author  NRW
 * @version 2015-10-25
 */
public class List<ContentType> {
    ...
    private class ListNode {
        ...
        /**
         * Der Inhalt des Knotens wird zurückgeliefert.
         * 
     ...
     * wenn die Liste keine Objekte enthält,
     ...
     * Ausführung des Auftrags kein aktuelles Objekt, d.h. hasAccess() liefert
     * den Wert false.
     */
    public void next() {
        if(this.hasAccess()) {
     ...
     * wird ein neues Objekt vor dem aktuellen Objekt in die Liste eingefügt. 
     * Das aktuelle Objekt bleibt unverändert. 
     * 
     * Wenn die Liste leer ist, wird pContent in die Liste eingefügt und 
     ...
     * 
     * @param   pContent    das einzufügende Objekt vom Typ ContentType
     */
     ...
     * wird die Liste pList an die aktuelle Liste angehängt. Anschließend 
     * wird pList eine leere Liste. Das aktuelle Objekt bleibt unverändert. 
     * Insbesondere bleibt hasAccess identisch.
     * 
     * @param   pList   die am Ende anzuhängende Liste vom Typ List<ContentType>
     */
     ...
     * das aktuelle Objekt gelöscht und das Objekt hinter dem gelöschten Objekt wird 
     * zum aktuellen Objekt. Wird das Objekt, das am Ende der Liste steht, gelöscht, 
    ...
    /**
     * Liefert den Vorgängerknoten des Knotens pNode. Ist die Liste leer 
     * (pNode == null) pNode nicht in der Liste oder pNode der erste Knoten 
     * der Liste, wird null zurückgegeben.
     *
     * @param   pNode   der Knoten, dessen Vorgänger zurückgegeben werden soll
     * 
     * @return  der Vorgänger des Knotens pNode oder null, falls die Liste leer ist,
